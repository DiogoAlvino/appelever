            ...
            try {
                ...
                const fullData: ForensicModel = {
                    ...
                    exames: {
                        ...
                        maquinaTracao: examsData.maquinaTracao || [],
                        limitadorVelocidade: examsData.limitadorVelocidade || [],
                        cabos: examsData.cabos || [],
                        contrapeso: examsData.contrapeso || [],
                        cabine: examsData.cabine || [],
                        portas: examsData.portas || [],
                        freiosEmergencia: examsData.freiosEmergencia || [],
                        sistemaControle: examsData.sistemaControle || [],
                        sistemaEletrico: examsData.sistemaEletrico || [],
                        sensores: examsData.sensores || [],
                        pocoElevador: examsData.pocoElevador || [],
                        vestigiosEquipamentos,
                        depoimentos: examsData.depoimentos || [],
                        vestigiosEntrevistas,
                        cadaverSexo: examsData.cadaverSexo || '',
                        cadaverCorPele: examsData.cadaverCorPele || '',
                        cadaverCabelo: examsData.cadaverCabelo || '',
                        cadaverSinaisIdentificadores: examsData.cadaverSinaisIdentificadores || '',
                        cadaverDescricaoVestes: examsData.cadaverDescricaoVestes || '',
                        cadaverOutro: examsData.cadaverOutro || '',
                        analiseDisposicaoCadaver: examsData.analiseDisposicaoCadaver || '',
                        arquivosDisposicaoCadaver: examsData.arquivosDisposicaoCadaver || [],
                        sinaisTanatologicos: examsData.sinaisTanatologicos || '',
                        arquivosTanatologicos: examsData.arquivosTanatologicos || [],
                        descricaoLesoesCadaver: examsData.descricaoLesoesCadaver || '',
