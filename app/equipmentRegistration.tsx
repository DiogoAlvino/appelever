  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <PrimarySection title="Dados do Equipamento">
        ...
        <PrimaryInput label="Modelo" value={detalhesEquipamento.modelo} onChangeText={(text) => { setDetalhesEquipamento({ ...detalhesEquipamento, modelo: text }); clearFieldError('modelo'); }} placeholder="Informe" error={!!errors.modelo} errorMessage={errors.modelo} />
